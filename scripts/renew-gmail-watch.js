...
// Every watched mailbox is on the Workspace tenant and authenticates via DWD.
// (The consumer-Gmail OAuth watch of 2026-08-21 was retired 2026-09-01 and
// removed 2026-09-06 — it is what produced the daily invalid_grant failures
// from 2026-08-29 on.)
async function callWatch(credentials, mailbox, topicPath) {
  const auth = gmailAuth(credentials, mailbox)
