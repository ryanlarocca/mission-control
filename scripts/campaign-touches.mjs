 ...
 * Ryan 2026-07-17; copy de-AI-ified 2026-07-20 per Ryan's test-send
 * feedback: NO em dashes, NO middle dots, human subject lines. Keep it
 * that way — plain hyphens, commas, and periods only.)
 *
 ...
 * 2026-08-24 (Ryan): every touch is 30 days after the previous one — "T2 one
 * month out from T1, then monthly." The July 14/21/35/40/45 ladder is gone.
 */
...
// exposure. The working opt-out line stays.
...
One relationship, multiple closings. Keep me in mind next time something fits.`,
  },
  {
    ...
    subject: "A few recent purchases",
    body: `Hi {{first_name}}, in case it helps to know I'm not just talk, here are a few recent purchases: 674 Kirkland Ave in Sunnyvale (6 units), 93 Ridgeview Ave and 1958 Limewood Dr in San Jose. Different stories, same pattern: bought as-is, closed quick, everyone moved on with their lives.
...
Before you spend another weekend holding it open, send it my way.`,
  },
  {
    ...
    subject: "If your buyer ever walks",
...
If anything's sitting on your desk you're not sure what to do with, happy to be a second set of eyes on it, even if I'm not the buyer.`,
  },
  {
    ...
    body: `Hi {{first_name}}, got a coming-soon, a seller who dreads showings, or a pocket listing? I'll make an offer before it ever hits the market. You keep your full commission and skip the photos, staging, and open-house grind.
...
If you've got one of these in your pipeline, I'm probably the easiest phone call you'll make on it.`,
  ...
  },
  {
    ...
    subject: "Thank you",
    body: `{{first_name}}, as the year wraps up, I just wanted to say thanks for staying connected. This business runs on relationships and I don't take them for granted.
