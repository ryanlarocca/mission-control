...
| Telegram lead alert | ☑ P5 (plan line) | ☑ P5 | ☑ P5 (reply = why, 🔁 button) | ☑ P5 (`surface=telegram`, `tg_message_id`) | ☑ P5 (✅ sends + executes) | ☑ P5 |
| Eval set + scoreboard | — | — | — | ☑ eval set + runner (P0/P1); ☑ scoreboard + weekly review (P6) | — | — |
